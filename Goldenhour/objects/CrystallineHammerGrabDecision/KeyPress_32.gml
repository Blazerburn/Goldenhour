...
if(global.recentlyInteracted == 0){	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	if(textSelected == 0){	/// @DnDAction : YoYo Games.Instances.Destroy_Instance
		...
		/// @DnDArgument : "value_1" "itemCrystallineHammer"
		/// @DnDArgument : "var_2" "_sprite"
		/// @DnDArgument : "value_2" "CrystallineHammer"
		/// @DnDArgument : "var_3" "_name"
		/// @DnDArgument : "value_3" ""Crystal Hammer""
		/// @DnDArgument : "var_4" "_uses"
		/// @DnDArgument : "value_4" "1"
		var _pos = 0;
		var _type = itemCrystallineHammer;
		var _sprite = CrystallineHammer;
		var _name = "Crystal Hammer";
		var _uses = 1;
	
		/// @DnDAction : YoYo Games.Instances.Call_User_Event
		/// @DnDVersion : 1
		/// @DnDHash : 6AE2E43B
		/// @DnDApplyTo : {CrystallineHammer_obj}
		/// @DnDParent : 73E529C7
		with(CrystallineHammer_obj) {
		event_user(0);
		}
