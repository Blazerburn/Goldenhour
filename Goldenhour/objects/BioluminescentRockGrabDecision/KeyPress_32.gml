...
if(global.recentlyInteracted == 0){	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	if(textSelected == 0){	/// @DnDAction : YoYo Games.Instances.Destroy_Instance
		...
		/// @DnDArgument : "value_1" "itemBioluminescentRock"
		/// @DnDArgument : "var_2" "_sprite"
		/// @DnDArgument : "value_2" "BioluminescentRock"
		/// @DnDArgument : "var_3" "_name"
		/// @DnDArgument : "value_3" ""Glowing Rock""
		/// @DnDArgument : "var_4" "_uses"
		/// @DnDArgument : "value_4" "1"
		var _pos = 0;
		var _type = itemBioluminescentRock;
		var _sprite = BioluminescentRock;
		var _name = "Glowing Rock";
		var _uses = 1;
	
		/// @DnDAction : YoYo Games.Instances.Call_User_Event
		/// @DnDVersion : 1
		/// @DnDHash : 59CB9FD4
		/// @DnDApplyTo : {BioluminescentRock_obj}
		/// @DnDParent : 73E529C7
		with(BioluminescentRock_obj) {
		event_user(0);
		}
