	...
	if(global.itemCheck == 2)
{
	...
	with(obj_Ruins1Puzzle6Door){
					...
					variable_instance_set(obj_Ruins1Puzzle6Door, "choice_variable", "Used");
					
					variable_instance_set(obj_Ruins1Puzzle6Door, "puzzleProgress", "1");
