...
if(global.combining == 1){	/// @DnDAction : YoYo Games.Common.Execute_Code
	...
	with(TestPlayer) {
		...
		if(itemArray[itemCombinePos1][itemAmount || itemUses] <= 0)
	{
		itemArray[itemCombinePos1][itemType] = itemNone;
	}
	
		if(itemArray[itemCombinePos2][itemAmount || itemUses] <= 0)
	{
