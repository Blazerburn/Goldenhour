...
if(global.combining == 1){	/// @DnDAction : YoYo Games.Common.Execute_Code
	...
	else if ((global.itemCombiningType1 == 4 || global.itemCombiningType1 == 10) && (global.itemCombiningType2 == 4 || global.itemCombiningType2 == 10))
	{
		show_debug_message("Right items")
		global.combining = 0;
	...
	with(TestConvo) {
		text[0] = "You stick the strange gel to the sides of the broken pieces and try to stick them back together";
		text[1] = "It takes a bit, but you eventually get all the pieces where you think they belong";
		text[2] = "You got a Fixed Path!";
