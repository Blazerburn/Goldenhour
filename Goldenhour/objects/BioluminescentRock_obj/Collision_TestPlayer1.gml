				...
				if(objectInteracted == 0){	/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Key_Pressed
					...
					var l59F3BD94_0;l59F3BD94_0 = keyboard_check_pressed(vk_space);if (l59F3BD94_0){	/// @DnDAction : YoYo Games.Common.Set_Global
						...
						with(TestConvo) {
							...
							/// @DnDInput : 6
							/// @DnDParent : 1FBEDEBA
							/// @DnDArgument : "expr" ""A glowing light pokes through the cracks of the rubble""
							/// @DnDArgument : "expr_1" ""You rummage your hands through the rubble""
							/// @DnDArgument : "expr_2" ""You feel something deathly cold, and pointed""
							/// @DnDArgument : "expr_3" ""You pull it out""
							/// @DnDArgument : "expr_4" ""It's a blue glowing rock shaped like a four pointed star""
							/// @DnDArgument : "expr_5" ""You're not sure why, but you feel a strong energy coming from it""
							...
							text[0] = "A glowing light pokes through the cracks of the rubble";
							text[1] = "You rummage your hands through the rubble";
							text[2] = "You feel something deathly cold, and pointed";
							text[3] = "You pull it out";
							text[4] = "It's a blue glowing rock shaped like a four pointed star";
							text[5] = "You're not sure why, but you feel a strong energy coming from it";
