...
x + xValue2, y + yValue2, x + xValue3, y + yValue3)) { global.inside_lay_alpha -= 0.05; 
	//global.outside_wall_lay_alpha -= 0.05
	global.outside_lay_alpha += 0.05; 
	//global.inside_wall_lay_alpha += 0.05
...
//global.inside_wall_lay_alpha = clamp(global.inside_wall_lay_alpha, 0, 0.5);
//global.outside_wall_lay_alpha = clamp(global.outside_wall_lay_alpha, 0, 1);

//show_debug_message(global.inside_lay_alpha);
//show_debug_message(global.outside_lay_alpha);
//show_debug_message(global.inside_wall_lay_alpha);
//show_debug_message(global.outside_wall_lay_alpha);
