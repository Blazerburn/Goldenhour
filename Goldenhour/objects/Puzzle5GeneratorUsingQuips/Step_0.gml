	...
	if(global.itemCheck == 2)
{
	...
	with(obj_Ruins1Puzzle5Generator){
					...
					variable_instance_set(obj_Ruins1Puzzle5Generator, "choice_variable", "Used");
					
					variable_instance_set(obj_Ruins1Puzzle5Generator, "puzzleProgress", "1");
