				...
				if(objectInteracted == 0){	/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Key_Pressed
					...
					var l59F3BD94_0;l59F3BD94_0 = keyboard_check_pressed(vk_space);if (l59F3BD94_0){	/// @DnDAction : YoYo Games.Common.Set_Global
						...
						with(TestConvo) {
							...
							/// @DnDInput : 2
							/// @DnDParent : 1FBEDEBA
							/// @DnDArgument : "expr" ""In the pile of rocks you notice a rock with an... interesting shape""
							/// @DnDArgument : "expr_1" ""It might be of use""
							/// @DnDArgument : "var" "text[0]"
							/// @DnDArgument : "var_1" "text[1]"
							text[0] = "In the pile of rocks you notice a rock with an... interesting shape";
							text[1] = "It might be of use";
							...
							/// @DnDParent : 1FBEDEBA
							/// @DnDArgument : "expr" "1"
							/// @DnDArgument : "expr_1" "ChiselRockGrabDecision"
							/// @DnDArgument : "var" "decisionsTrue"
							/// @DnDArgument : "var_1" "decisions"
							decisionsTrue = 1;
							decisions = ChiselRockGrabDecision;
						}
